...
\begin{titlepage}
    ...
    %\begin{center}
    %    \includegraphics[width=8cm]{img/logounipi.png}
    %\end{center}
...
The patent screening confirms that the use of AI, telematics and OBD data for predictive maintenance is not novel by itself. Therefore, the proposed venture should differentiate primarily through a lightweight, hardware-agnostic SaaS model for small and medium-sized multi-brand fleets, reduced integration effort and interpretable, prioritized maintenance alerts. BOH SI TOGLIE ?!!? The identified documents also suggest that an eventual commercial launch would require a claim-level intellectual-property review.
...
Table %~\ref{tab:competitor-comparison} 
